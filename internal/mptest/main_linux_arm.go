...
func findEnd(tls *libc.TLS, z uintptr, pnLine uintptr) int32 { /* testdata/mptest.c:767:12: */
	var n int32 = 0
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 && (libc.Xstrncmp(tls, z+uintptr(n), ts+898, uint32(5)) != 0 || !(int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*uint8)(unsafe.Pointer(z + uintptr(n+5))))))*2)))&int32(_ISspace) != 0)) {
...
func findEndif(tls *libc.TLS, z uintptr, stopAtElse int32, pnLine uintptr) int32 { /* testdata/mptest.c:780:12: */
	...
	for *(*uint8)(unsafe.Pointer(z + uintptr(n))) != 0 {
		...
		if libc.Xstrncmp(tls, z+uintptr(n), ts+904, uint32(7)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*uint8)(unsafe.Pointer(z + uintptr(n+7))))))*2)))&int32(_ISspace) != 0 ||
			stopAtElse != 0 && libc.Xstrncmp(tls, z+uintptr(n), ts+912, uint32(6)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*uint8)(unsafe.Pointer(z + uintptr(n+6))))))*2)))&int32(_ISspace) != 0 {
			return n + len
		}
		if libc.Xstrncmp(tls, z+uintptr(n), ts+919, uint32(4)) == 0 && int32(*(*uint16)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(libc.X__ctype_b_loc(tls))) + uintptr(int32(uint8(*(*uint8)(unsafe.Pointer(z + uintptr(n+4))))))*2)))&int32(_ISspace) != 0 {
...
func runScript(tls *libc.TLS, iClient int32, taskId int32, zScript uintptr, zFilename uintptr) { /* testdata/mptest.c:876:13: */
	...
	*(*int32)(unsafe.Pointer(bp + 372 /* lineno */)) = 1
	...
	for libc.AssignInt32(&c, int32(*(*uint8)(unsafe.Pointer(zScript + uintptr(ii))))) != 0 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1215) == 0 {
		...
		// has begun.
		if libc.Xstrcmp(tls, bp+376, ts+1220) == 0 {
			if g.iTrace == 1 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1229) == 0 && iClient > 0 {
			finishScript(tls, iClient, taskId, 1)
		} else
		...
		if libc.Xstrcmp(tls, bp+376, ts+1236) == 0 {
			stringReset(tls, bp+360)
		} else
		...
		if libc.Xstrcmp(tls, bp+376, ts+1242) == 0 {
			var jj int32
		...
		// ANSWER.
		if libc.Xstrcmp(tls, bp+376, ts+1293) == 0 || libc.Xstrcmp(tls, bp+376, ts+1298) == 0 {
			var jj int32
			var zAns uintptr = zScript + uintptr(ii)
			var zCopy uintptr
		...
		if libc.Xstrcmp(tls, bp+376, ts+1349) == 0 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1356) == 0 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1407) == 0 {
			var jj int32
		...
		if libc.Xstrcmp(tls, bp+376, ts+1413) == 0 {
			var jj int32
			var rc int32
			var pStmt uintptr
		...
		if libc.Xstrcmp(tls, bp+376, ts+1428) == 0 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1433) == 0 {
			// no-op
		} else
		...
		if libc.Xstrcmp(tls, bp+376, ts+1439) == 0 && iClient == 0 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1445) == 0 && iClient == 0 {
			var iTimeout int32
			if nArg >= 2 {
		...
		// already.
		if libc.Xstrcmp(tls, bp+376, ts+1465) == 0 && iClient == 0 {
		...
		if libc.Xstrcmp(tls, bp+376, ts+1569) == 0 {
			test_breakpoint(tls)
		} else
		...
		if libc.Xstrcmp(tls, bp+376, ts+1580) == 0 {
	...
	if iClient > 0 {
		...
		for 1 != 0 {
			*(*uintptr)(unsafe.Pointer(bp + 244 /* zTaskName */)) = uintptr(0)
			...
			if g.iTrace != 0 {
				logMessage(tls, ts+2904, libc.VaList(bp+136, *(*uintptr)(unsafe.Pointer(bp + 244 /* zTaskName */)), *(*int32)(unsafe.Pointer(bp + 240 /* taskId */))))
			}
			...
			if g.iTrace != 0 {
				logMessage(tls, ts+2918, libc.VaList(bp+152, *(*uintptr)(unsafe.Pointer(bp + 244 /* zTaskName */)), *(*int32)(unsafe.Pointer(bp + 240 /* taskId */))))
			}
